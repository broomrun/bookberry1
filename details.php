...
<body>
    ...
    <div class="book-info">
        <div class="rating-container">
            ...
            <div class="rating" id="comment-rating-1">
                ...
                <span onclick="rateComment(3, '1')">⭐</span>
                <span onclick="rateComment(4, '1')">⭐</span>
                <span onclick="rateComment(5, '1')">⭐</span>
            </div>
            <p id="comment-average-rating-1">Rating: 0</p>
        </div>
        <div class="book-details">
            ...
            <div class="additional-info">
                <div class="add-album">
                    <button onclick="addAlbum()">Add to Album</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="comment-body">
            <div class="ratings" id="comment-rating-input">
